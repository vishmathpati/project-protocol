...
3. **BRAND.md** — product identity and what NOT to build (if it exists)
4. **BRIEF.md** — every major decision made in Cowork and why, including rejected options (if it exists)
5. **docs/INDEX.md** — project map + agent dependency index (if it exists)
