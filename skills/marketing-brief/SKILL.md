...
Read BRIEF, STRUCTURE, BRAND, WONT-DO, existing marketing canon, relevant product code/docs, and real proof sources. Reuse universal and brand answers; ask only marketing gaps.
...
## Stage B — final content lock

After research/style direction is available, finalize copy, proof, media, section intent, and source traceability. Do not choose page composition or component layout; Build Page owns that conversation.
...
Use the shipped CONTENT, SITEMAP, PAGE-BRIEF, and MEDIA templates. Preserve useful existing project marketing canon, but do not preserve unsafe placeholder-proof rules from older plugin versions.
