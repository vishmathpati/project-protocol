...
> 4. Hand the rendered prompt to Vish; he pastes it into Aside.
>
...
Run the design-research skill you have installed. This prompt is the project brief.
...
DEPTH
research_depth: <research-depth> — <depth-meaning>
...
<archetype>          ← brain/DESIGN.md frontmatter archetype:                 (marketing / dashboard / content / commerce / app)
<archetype-meaning>  ← brain/BRAND.md ## Brand · Archetype (primary)          (the one-line meaning)
...
<research-depth>     ← brain/DESIGN.md frontmatter research_depth:              (quick / standard / deep)
...
Pasted into the SAME Aside chat as Round 1, after Vish (with Claude) picks or blends a concept at the
...
Run the design-research skill you have installed (same chat as Round 1). This directive is the task.
...
```
<project>         ← brain/BRAND.md ## Product · Name  (also brain/DESIGN.md frontmatter name:)
<chosen-concept>  ← the checkpoint decision (Spec §4) written to brain/BRAND.md — Decisions log line +
                    Locked direction seed. Single concept letter/name.
<blend-picks>     ← same checkpoint decision, when Vish blended — expressed as explicit component-level
                    picks, e.g. "A.hero + B.type" (from the brain/BRAND.md decision)
<brain-abs>       ← this project's brain/ absolute path (e.g. /Users/…/<project>/brain)
